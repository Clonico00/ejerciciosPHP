...
<nav>
    <ul>
        ...
        <li><a href="http://localhost:63342/ejercicios/UD9_OrganizacionCodigo/clinica/indexFrontController.php?controller=Doctor&action=registro">Registrar un nuevo doctor</a></li>
    </ul>
</nav>
